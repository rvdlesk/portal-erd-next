          ...
          <div className="row">
            ...
            <div className="col-6 col-md-2">
              ...
              <ul className="footer-menu-list">
                <li>
                  <a href="#">Ejército de Republica Dominicana (ERD)</a>
                </li>
              </ul>
            </div>
            <div className="col-md-2 col-6">
              ...
              <ul className="footer-menu-list">
                <li>
                  <a href="#">Tel: (809) 473-8000</a>
                </li>
                {/* <li><a href="#">Fax: (809)-732-5465</a></li> */}
                <li>
                  <a href="#">info@ejercito.mil.do</a>
                </li>
              </ul>
            </div>
            <div className="col-md-2 col-6">
              ...
              <ul className="footer-menu-list">
                <li>
                  <span>
                    Autopista Duarte Km. 25 , Campamento Militar 16 de agosto,
                    Municipio Pedro Brand , R.D.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="footer-bottom-cont">
            ...
            <div className="footer-bottom-right">
              ...
              <ul className="follow-icons">
                <li>
                  <a
                    href="https://www.facebook.com/EjercitoRD/"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.youtube.com/user/ejercitord"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://twitter.com/ejercitord"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://www.instagram.com/ejercitord"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
